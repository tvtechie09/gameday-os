...
import { createFamilyAmenity, getFamilyPlacesAdmin, setFamilyPlaceVisibility } from "@/lib/services/family-places";
...
export default async function FamilyPlacesAdminPage({ params }: { params: Promise<{ venueId: string }> }) {
  ...
  const rows = await getFamilyPlacesAdmin(venueId);
  ...
  return <section className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(320px,.7fr)]">
