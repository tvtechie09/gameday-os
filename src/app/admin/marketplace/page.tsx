  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-6 sm:px-6">
      <header className="border-b border-[var(--line)] pb-5">
        ...
        <h1 className="mt-1 text-2xl font-black text-[var(--foreground)] sm:text-3xl">Automation Marketplace</h1>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--muted)]">
          Platform-only. Install and configure automation recipes and integrations. Placeholder for the marketplace
          catalog.
        </p>
      </header>
