...
export default async function OrgHomePage() {
  ...
  return (
    <PageShell>
      ...
      } eyebrow="Organization" title={organization?.name ?? "Your organization"} />

      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <Link href="/org/reservations" className="ui-surface min-h-36 p-5 transition-colors hover:border-[var(--accent)] hover:bg-[var(--accent-soft)]">
        ...
        <Link href="/org/coaches" className="ui-surface min-h-36 p-5 transition-colors hover:border-[var(--accent)] hover:bg-[var(--accent-soft)]">
        ...
        <Link href="/admin/billing" className="ui-surface min-h-28 p-5 transition-colors hover:border-[var(--accent)] hover:bg-[var(--accent-soft)]">
          <p className="text-lg font-black">Billing</p>
          <p className="mt-2 text-sm text-[var(--muted)]">View your plan and invoices (read-only).</p>
        </Link>
        <Link href="/org/settings" className="ui-surface min-h-28 p-5 transition-colors hover:border-[var(--accent)] hover:bg-[var(--accent-soft)]">
