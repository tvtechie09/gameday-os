    ...
    >
      <div className="flex max-h-[inherit] flex-col">
        <header className="flex items-start justify-between gap-4 border-b border-[var(--line)] px-5 py-4">
          <div><h2 className="text-xl font-black" id={titleId}>{title}</h2>{description ? <p className="mt-1 text-sm leading-6 text-[var(--muted)]" id={descriptionId}>{description}</p> : null}</div>
